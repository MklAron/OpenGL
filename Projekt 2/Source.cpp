...
glm::vec3 controlPointsColor = glm::vec3(0.7f, 0.7f, 0.0f);
glm::vec3 controlPoligonColor = glm::vec3(0.8f, 0.1f, 0.2f);
glm::vec3 bezierCurveColor = glm::vec3(0.2f, 0.0f, 0.9f);
